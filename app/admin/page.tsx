  ...
  return (
    <div className="min-h-screen bg-neutral-50 pb-16 dark:bg-neutral-950">
      ...
      <main className="mx-auto flex max-w-3xl flex-col gap-8 px-4 py-10 sm:px-6">
        ...
        <Section
          title="国会当番の指定（管理職指示）"
          description="国会月当番は対象月の全日の平日に同一人物が入ります。国会週当番は「第1週＝その月で最初の月曜より前の日」「第2週以降＝最初の月曜から次の月曜前日までのブロック」として月内で番号が振られ、各週の平日は同一人物が担当します（月初が月曜の月は第1週に該当する日はなく、最初の月曜からのブロックが第1週になります）。会期中は月＋週の2名、閉会中は月のみ1名です。月当番と同一人物を週当番に指定することはできません。"
        >
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
